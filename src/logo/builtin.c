...
static const FFlogo A[] = {
    ...
    {
        .names = {"asahi_small"},
        .lines = FASTFETCH_DATATEXT_LOGO_ASAHI_SMALL,
        .type = FF_LOGO_LINE_TYPE_ALTER_BIT,
        .colors =
            {
                FF_COLOR_FG_YELLOW,
    ...
    // AsteroidOS
    {
        ...
        .colors = {FF_COLOR_FG_256 "160", FF_COLOR_FG_256 "208",
                   FF_COLOR_FG_256 "202", FF_COLOR_FG_256 "214"},
...
static const FFlogo C[] = {
    ...
    // CachyOSSmall
    {
        .names = {"Cachy_small", "cachyos_small", "cachy-linux-small",
                  "cachyos-linux-small"},
        .type = FF_LOGO_LINE_TYPE_SMALL_BIT,
    ...
    // CentOSSmall
    {
        .names = {"Cent_small", "centos_small", "cent-linux_small",
                  "cent-linux-small", "centos-linux-small"},
        .type = FF_LOGO_LINE_TYPE_SMALL_BIT,
    ...
    // Cereus
    {
        ...
        .colors = {FF_COLOR_FG_256 "173", FF_COLOR_FG_256 "108",
                   FF_COLOR_FG_256 "71", FF_COLOR_FG_256 "151",
                   FF_COLOR_FG_256 "72"},
    ...
    // ContainerLinux
    {
        .names = {"ContainerLinux", "Container Linux",
...
static const FFlogo E[] = {
    ...
    // Endeavour
    {
        .names = {"Endeavour", "endeavour-linux", "endeavouros",
                  "endeavouros-linux"},
    ...
    // EndeavourSmall
    {
        .names = {"Endeavour_small", "endeavour-linux_small",
                  "endeavouros_small", "endeavouros-linux_small"},
        .type = FF_LOGO_LINE_TYPE_SMALL_BIT,
...
static const FFlogo F[] = {
    ...
    // FedoraOld
    {
        .names = {"Fedora_old", "fedora-old", "fedora-linux-old",
                  "fedora-linux_old"},
        .type = FF_LOGO_LINE_TYPE_ALTER_BIT,
    ...
    // FedoraSilverblue
    {
        .names = {"Fedora_silverblue", "fedora-silverblue",
                  "fedora-linux-silverblue", "fedora-linux_silverblue"},
        .type = FF_LOGO_LINE_TYPE_ALTER_BIT,
    ...
    // FedoraKinoite
    {
        .names = {"Fedora_kinoite", "fedora-kinoite", "fedora-linux-kinoite",
    ...
    // FedoraSericea
    {
        .names = {"Fedora_sericea", "fedora-sericea", "fedora-linux-sericea",
    ...
    // FedoraCoreOS
    {
        .names = {"Fedora_coreos", "fedora-coreos", "fedora-linux-coreos",
                  "fedora-linux_coreos"},
        .type = FF_LOGO_LINE_TYPE_ALTER_BIT,
        .lines = FASTFETCH_DATATEXT_LOGO_FEDORA_COREOS,
        .colors =
...
static const FFlogo N[] = {
    ...
    // NixOSSmall
    {
        .names = {"NixOS_small", "nix_small", "nixos-linux-small",
                  "nix-linux-small"},
        .type = FF_LOGO_LINE_TYPE_SMALL_BIT,
    ...
    // NixOsOldSmall
    {
        .names = {"nixos_old_small", "nix-old-small", "nixos-old-small",
                  "nix_old_small"},
        .type = FF_LOGO_LINE_TYPE_SMALL_BIT | FF_LOGO_LINE_TYPE_ALTER_BIT,
...
static const FFlogo O[] = {
    ...
    // OpenSuseTumbleweed
    {
        .names = {"opensuse_tumbleweed", "open_suse_tumbleweed",
                  "opensuse-tumbleweed", "open-suse-tumbleweed",
                  "suse_tumbleweed", "suse-tumbleweed", "opensusetumbleweed"},
    ...
    // openSUSESlowroll
    {
        .names = {"opensuse_slowroll", "opensuse-slowroll",
...
static const FFlogo P[] = {
    ...
    // PNMLinux
    {
        ...
        .colors = {FF_COLOR_FG_BLUE, FF_COLOR_FG_RED, FF_COLOR_FG_WHITE,
                   FF_COLOR_FG_256 "202"},
    },
    // Pop
    {
    ...
    // PopSmall
    {
        .names = {"pop_small", "popos_small", "pop_os_small",
                  "pop-linux-small"},
        .type = FF_LOGO_LINE_TYPE_SMALL_BIT,
...
static const FFlogo R[] = {
    ...
    // RaspbianSmall
    {
        .names = {"raspbian_small", "raspi_small", "raspberrypi_small",
                  "raspberrypios_small"},
        .type = FF_LOGO_LINE_TYPE_SMALL_BIT,
    ...
    // Reborn
    {
        .names = {"Reborn", "Reborn OS", "reborn-os", "rebornos",
                  "rebornos-linux", "reborn-os-linux"},
    ...
    // RebornSmall
    {
        .names = {"Reborn_small", "Reborn OS_small", "reborn-os-small",
                  "rebornos_small", "rebornos-linux-small",
    ...
    // RedstarOS
    {
        .names = {"redstar", "redstar-os", "redstaros", "redstaros-linux",
                  "redstar-os-linux"},
...
static const FFlogo S[] = {
    ...
    // SlackwareSmall
    {
        .names = {"slackware-small", "slackware-linux-small", "slackware_small",
    ...
    // Source Mage
    {
        .names = {"Source Mage", "Source Mage GNU/Linux", "source_mage",
                  "sourcemage"},
    ...
    // SolarisSmall
    {
        .names = {"solaris-small", "solaris_small", "sunos-small",
                  "sunos_small"},
        .type = FF_LOGO_LINE_TYPE_SMALL_BIT,
...
static const FFlogo T[] = {
    ...
    // TorizonCore
    {
        ...
        .colors = {FF_COLOR_FG_LIGHT_WHITE, FF_COLOR_FG_YELLOW,
                   FF_COLOR_FG_BLUE},
    },
    // Trisquel
    {
...
static const FFlogo W[] = {
    ...
    // Windows8
    {
        .names = {"Windows 8", "Windows 8.1", "Windows 10",
    ...
    // Windows
    {
        .names = {"Windows", "Windows 7", "Windows Server 2008",
